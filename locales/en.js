export default {
  ...
  "forgotPassword": {
    ...
    "messageFirstPart": "If there is an account associated with",
    "messageSecondPart": "you will receive an email shortly.<br>Please check your inbox and follow the instructions in the email.",
  ...
  "homePage": {
    ...
    "manageYourContribution": "Manage your contribution",
  ...
  "join": {
    ...
    "errors": {
      "confirmEmail": {
        "message": "Almost there! We just need to confirm your email address to finish setting up your membership.",
  ...
  "notification": {
    ...
    "success": "Well done! Your action was successful."
  },
  "resetPassword": {
    "changePassword": "Change password",
    "confirmPassword": "Confirm password",
    "description": "Set a new password to login.",
