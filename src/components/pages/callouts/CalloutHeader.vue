<template>
  <div
    class="flex-0 z-10 flex flex-col gap-2 p-4 shadow-lg md:flex-row md:items-center md:p-6 md:p-6"
  >
...
import { faImages, faMap, faPlus } from '@fortawesome/free-solid-svg-icons';
...
const props = defineProps<{
  callout: GetCalloutDataWith<'responseViewSchema'>;
  map?: boolean;
}>();
